...
tab0_content= dbc.Row([html.H4("Geometry Analysis",className='mt-3 display-9 text-uppercase align-right text-secondary bg-secondary text-center'),
        dbc.Col([graph_card],width={'size':7, 'order':1},class_name='d-*-block '),
        dbc.Col([
            graph_card_2,table_card_3
            ],width={'size':5, 'order':2},align='top',md=5 )
        ],justify='center',class_name='d-*-block bg-light')
    

tab1_content= dbc.Row([
        dbc.Col([graph_card_1_t1],class_name='d-*-block bg-secondary shadow-sm'),
        dbc.Col([PDFtabs],class_name='d-*-block bg-secondary shadow-sm')
